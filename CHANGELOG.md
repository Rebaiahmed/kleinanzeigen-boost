...
### Added
- show a dedicated message on non-Chromium browsers
- disable eBay (coming soon) + add "Jetzt" immediate repost option
...
### Fixed
- rename login route /auth → /login (friendlier URL)
...
### Changed
- ci+docs: automation worker deploy workflow; simplify README
