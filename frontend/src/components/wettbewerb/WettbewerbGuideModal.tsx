...
const STEP_KEYS = [
  { n: 1, titleKey: 'wettbewerb.guide.step1Title', textKey: 'wettbewerb.guide.step1Text' },
  { n: 2, titleKey: 'wettbewerb.guide.step2Title', textKey: 'wettbewerb.guide.step2Text' },
        ...
        <div className="p-5 space-y-4">
          {STEP_KEYS.map((step) => (
            <div key={step.n} className="flex gap-3">
              ...
              <div>
                <p className="text-[13px] font-semibold text-[#333]">{t(step.titleKey)}</p>
                <p className="text-[12px] text-[#666] mt-0.5">{t(step.textKey)}</p>
              </div>
            </div>
          ))}
        </div>
