...
function TemplatesSchematic() {
  return (
    <div className="w-full max-w-[240px] mx-auto space-y-2">
      ...
      <div className="flex justify-end"><div className="rounded-2xl rounded-br-sm bg-[#e8f1fb] border border-[#cfe0f5] px-3 py-2 text-[12px] text-slate-700">Ja, noch verfügbar! 🙂</div></div>
