  ...
  return (
    <div className="w-full relative">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <h1 className="text-2xl font-bold text-[#333]">Meine Entwürfe</h1>
        <button
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 text-[#666]">
          <p className="mb-3">Noch keine Entwürfe gespeichert.</p>
          <p className="text-[13px] text-[#999]">
            Erstelle eine Anzeige mit KI und klicke „Als Entwurf speichern" — sie erscheint dann hier.
          </p>
        </div>
      ) : (
        <div className="space-y-3">
          ...
          <div className="bg-white rounded-sm shadow-xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="px-5 py-3 border-b border-[#e5e5e5] flex justify-between items-center">
              <h3 className="text-[16px] font-semibold text-[#333] flex items-center gap-2">
                <Trash2 className="w-4 h-4 text-red-600" /> Entwurf löschen?
              </h3>
            ...
            <div className="p-5">
              <p className="text-[13px] text-[#555] mb-5">
                Der Entwurf und alle zugehörigen Fotos werden endgültig gelöscht. Das kann nicht rückgängig gemacht werden.
              </p>
